...
export function MagicCard(props: MagicCardProps) {
  ...
  const glowTo = isOrbMode(props) ? (props.glowTo ?? "#93c5fd") : "#93c5fd"
    ...
    >
      ...
      {mode === "gradient" && (
        <motion.div
          ...
          className="pointer-events-none absolute inset-px z-30 rounded-3xl opacity-0 transition-opacity duration-300 group-hover:opacity-100"
          style={{
            background: useMotionTemplate`
              radial-gradient(${gradientSize}px circle at ${mouseX}px ${mouseY}px,
                ${gradientColor},
